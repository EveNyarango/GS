...
public class VideoFragment extends RecyclerView.ViewHolder {


    public VideoFragment(@NonNull View itemView) {
        super(itemView);
    }
    ...
    public  void SetVideo(FragmentActivity activity, String name, String url, String postUri, String time, String uid, String type, String desc){
        ...
        PlayerView playerView = itemView.findViewById(R.id.vv_post_videos);
